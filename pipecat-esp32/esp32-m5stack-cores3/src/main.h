...
extern void pipecat_screen_show_connecting();
extern void pipecat_screen_show_connected();
extern void pipecat_screen_show_qr_code(const char *text);
extern void pipecat_screen_hide_qr_code();
